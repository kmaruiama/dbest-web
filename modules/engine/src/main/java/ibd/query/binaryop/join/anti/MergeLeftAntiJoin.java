 ...
 * @author Sergio
 */
public class MergeLeftAntiJoin extends Join {
     ...
     * @throws Exception
     */
    public MergeLeftAntiJoin(Operation leftOperation, Operation rightOperation, JoinPredicate terms) throws Exception {
