 ...
 * @author Sergio
 */
public class MergeRightOuterJoin extends Join {
     ...
     * @throws Exception
     */
    public MergeRightOuterJoin(Operation leftOperation, Operation rightOperation, JoinPredicate terms) throws Exception {
