 ...
 * @author Sergio
 */
public class MergeLeftOuterJoin extends Join {
     ...
     * @throws Exception
     */
    public MergeLeftOuterJoin(Operation leftOperation, Operation rightOperation, JoinPredicate terms) throws Exception {
