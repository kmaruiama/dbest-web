 ...
 * @author Sergio
 */
public class HashUnion extends Set implements SingleSource{
    ...
    public HashUnion(Operation leftOperation, Operation rightOperation, String alias) throws Exception {
