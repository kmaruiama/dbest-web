 ...
 * @author Sergio
 */
public class MergeRightSemiJoin extends Join {
     ...
     * @throws Exception
     */
    public MergeRightSemiJoin(Operation leftOperation, Operation rightOperation, JoinPredicate terms) throws Exception {
